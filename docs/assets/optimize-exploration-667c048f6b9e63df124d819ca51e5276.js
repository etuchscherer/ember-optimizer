...
return Object.defineProperty(n,"__esModule",{value:!0}),n}catch(r){throw new Error('Could not read config from meta tag with name "'+e+'".')}})),runningTests||require("optimize-exploration/app").default.create({name:"optimize-exploration",version:"0.0.0+f7d87f2b"})
