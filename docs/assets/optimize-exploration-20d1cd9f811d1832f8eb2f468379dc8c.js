...
e.default=i})),define("optimize-exploration/initializers/component-override",["exports"],(function(e){function t(){Ember.Component.reopen({didRender:function(){return window.dataLayer.push({event:"optimize.activate"}),this._super.apply(this,arguments)}})}Object.defineProperty(e,"__esModule",{value:!0}),e.initialize=t,e.default=void 0
var n={initialize:t}
...
return Object.defineProperty(n,"__esModule",{value:!0}),n}catch(o){throw new Error('Could not read config from meta tag with name "'+e+'".')}})),runningTests||require("optimize-exploration/app").default.create({name:"optimize-exploration",version:"0.0.0+784a699a"})
