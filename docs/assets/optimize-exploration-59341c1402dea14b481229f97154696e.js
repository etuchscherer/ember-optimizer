...
var u=Ember.HTMLBars.template({id:"608hn0JF",block:'{"symbols":[],"statements":[[2,"This is the left control pane"]],"hasEval":false,"upvars":[]}',meta:{moduleName:"optimize-exploration/components/left-pane.hbs"}}),l=function(e){(function(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function")
...
var t=Ember.HTMLBars.template({id:"Y+Ry44OD",block:'{"symbols":[],"statements":[[2,"This is the right control pane"]],"hasEval":false,"upvars":[]}',meta:{moduleName:"optimize-exploration/components/right-pane.hbs"}}),n=Ember._setComponentTemplate(t,Ember._templateOnlyComponent())
...
e.default=i})),define("optimize-exploration/initializers/component-override",["exports"],(function(e){function t(){Ember.Component.reopen({didRender:function(){return console.log("pushing optimize.activate"),window.dataLayer.push({event:"optimize.activate"}),this._super.apply(this,arguments)}})}Object.defineProperty(e,"__esModule",{value:!0}),e.initialize=t,e.default=void 0
var n={initialize:t}
...
return Object.defineProperty(n,"__esModule",{value:!0}),n}catch(o){throw new Error('Could not read config from meta tag with name "'+e+'".')}})),runningTests||require("optimize-exploration/app").default.create({name:"optimize-exploration",version:"0.0.0+10494cf0"})
